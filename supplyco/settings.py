...
EMAIL_HOST_USER = 'salomiait@gmail.com'
EMAIL_HOST_PASSWORD = 'uardgdmpdltcvqkz'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
WSGI_APPLICATION = 'supplyco.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'supplyco/static')]
STATIC_ROOT = os.path.join(BASE_DIR, 'static') # Automatically Created on Production


# Settings for Media
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'supplyco/media')
